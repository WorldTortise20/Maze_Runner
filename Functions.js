...
function start(){
    ...
    if(gs==="win"){
        yeetLv1();
        alert("You escaped... A new trial awaits you... Choose your next trial....");
        alert("Copy paste ONE of these links into the url");
        alert("First Trial:          https://worldtortise20.github.io/Lv2_Trex/");
        alert("Only other trial... Trial Two:          https://worldtortise20.github.io/Lv2_GhostJumper/")
